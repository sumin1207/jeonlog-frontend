  ...
  export namespace ExpoRouter {
    export interface __routes<T extends string | object = string> {
      hrefInputParams:
        ...
        | {
            pathname: `/../components/ui/Skeleton`;
            params?: Router.UnknownInputParams;
          }
        | {
            pathname: `/../data/exhibitionsDataStorage`;
            params?: Router.UnknownInputParams;
          }
        ...
        | {
            pathname:
              | `${"/(tabs)"}/mypage/exhibition/liked`
              | `/mypage/exhibition/liked`;
            params?: Router.UnknownInputParams;
          }
        | {
            pathname:
      ...
      href:
        ...
        | `/../components/ui/Skeleton${`?${string}` | `#${string}` | ""}`
        | `/../data/exhibitionsDataStorage${`?${string}` | `#${string}` | ""}`
        ...
        | `${"/(tabs)"}/mypage/exhibition/liked${
            ...
            | `#${string}`
            | ""}`
        | `/mypage/exhibition/liked${`?${string}` | `#${string}` | ""}`
        | `${"/(tabs)"}/mypage/exhibition/thumbs-up${
            | `?${string}`
            | `#${string}`
            | ""}`
