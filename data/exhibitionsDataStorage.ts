export const exhibitionData = {
  "1": {
    ...
    explanationImages: [ //설명 포스터 이미지 삽입
  ...
  "6": {
    ...
    explanation:"🎠그네와 미디어 아트가 만나다. 몽환적인 사운드와 함께 그네를 타며 중력·속도·시간 등 과학법칙 속 인문철학을 예술적으로 체험하는 전시 🎵 미디어아트 레이블 ‘VERSEDAY’와 뮤지션 ‘오혁’의 협업으로 만들어졌어요! 그네 한 번 타면… 자꾸 생각날 걸요? 😎 💫 서브 콘텐츠 🐾 귀여운 캐릭터들과 체험 + 굿즈존 우주먼지(@pettydust ), 왈맹이(@waalmaeng ), 파파고파파(@papa.go.papa ), 헐랭이물개(@nopaper.studio )가 어른이들의 마음을 지켜주러 DDP 쇼룸에 왔어요! 캐릭터랑 놀고, 굿즈는 맘껏 쇼핑 고고~ “충동구매는 어른이보호구역에서 감사합니다“ 🎁 ",
  ...
  "7": {
    id: "7",
    title: "프래그런스 위드 플래닛",
    subtitle: "프래그런스 위드 플래닛(FRAGRANCE WITH PLANET)스토리텔링 팝업 전시",
  ...
  "8": {
    ...
    subtitle: "전시 <What’s your favorite chair> DDP 매거진 라이브러리 x 매거진<C>",
